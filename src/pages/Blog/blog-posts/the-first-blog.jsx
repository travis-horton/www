...
const TheFirstBlog = () =>
  <div class="container">
    <main class="content">
      <div class="main">
        <h1 class="blog_title">The First Blog Post</h1>
        ...
        <p>Right now I'm working through <a href="https://www.nand2tetris.org/" target="_blank">Nand2Tetris</a>. I'm on the Chapter 3: Sequential Logic (<a href="./ch3_sequential_logic.pdf" download="Sequential Logic.pdf">pdf</a>), and I found the first thing they don't really explain: how you build what's called a D Flip Flop. After doing some googling, I have found it's pretty complicated, so maybe my first blog post will be me trying to explain how they work? That would be a good challenge.</p>
        <hr/>
        <p>A little code:</p>
