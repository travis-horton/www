  ...
  <div className="container">
    <main className="content">
      <div className="main">
        ...
        <p>From MDN:</p>
        <blockquote><code>this</code>: A property of an execution context (global, function or eval) that, in non–strict mode, is always a reference to an object and in strict mode can be any value.</blockquote>
        ...
        <h3>A simple function call:</h3><p><code>this</code> is just the global object (<code>window</code> in the DOM).</p>
        ...
        <h4><code>call</code> and <code>apply</code>:</h4><p>From a cursory search of the internet, the difference between these two seems purely syntactical: they both allow you to assign a specific object to the local <code>this</code> when calling a function.</p>
        ...
        <h3><code>bind</code>:</h3><p>A different beast: <code>bind</code> is a built-in function.prototype method that creates a new function from (1) the called function and (2) a given object that <code>bind</code>'s itself to the new function as the new function's <code>this</code>.</p>
        <h3>Arrow functions:</h3><p>In ES6 <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions">Arrow functions</a> were introduced. They are worthy of <a href="https://hacks.mozilla.org/2015/06/es6-in-depth-arrow-functions/">several</a> <a href="https://stackabuse.com/arrow-functions-in-javascript/">different</a> <a href="https://developer.blog/es6-arrow-functions/">articles</a> in themselves. For the purposes of these notes, the important thing to remember is that <code>this</code> retains the value it had within whatever called the arrow function. This functionality can be useful for using helper functions within other functions, for class constructions, and other fun things too.</p>
        <h3>Other cases</h3><p>There are essentially three other cases where <code>this</code> has different functionality:</p>
        <ol><li>objects: <code>this</code> is the object</li><li>constructors: <code>this</code> is the new object being created</li><li>and event handlers: <code>this</code> is the element that fired the event</li></ol>
        <p>The <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/this">MDN Docs</a> go into much more detail about those three cases.</p>
      </div>
    </main>
  </div>;
